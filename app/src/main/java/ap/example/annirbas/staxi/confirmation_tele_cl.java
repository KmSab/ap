...
public class confirmation_tele_cl extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmation_tele_cl);
    ...
    {
        Intent intent = new Intent(this, forclins.class);
        Toast.makeText(confirmation_tele_cl.this,"entrez tes informations",Toast.LENGTH_LONG).show();
