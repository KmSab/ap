...
public class confirmation_tax_oub extends Activity{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_confirmation_tax_oub);
    ...
    {
        Intent intent = new Intent(this, Motpassetaxoublie.class);
