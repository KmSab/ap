...
public class mescourse extends AppCompatActivity {
    //adapter class
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mescourse);

                Intent i3 = getIntent();
        Bundle b = i3.getExtras();
        idobesrve=(String) b.get("id");
        i3.putExtra("id",idobesrve);
Toast.makeText(mescourse.this,idobesrve,Toast.LENGTH_SHORT).show();
        ...
        String url="http://192.168.8.2/app/mescourses.php?cod_cl="+idobesrve;
    ...
    private class MyCustomAdapter extends BaseAdapter {
        ...
        public View getView(int position, View convertView, ViewGroup parent)
        {
            ...
            TextView sexpre=( TextView)myView.findViewById(R.id.sexpre);
            sexpre.setText(s.Sex_tax_pref);
        ...
        protected void onProgressUpdate(String... progress) {
            ...
            try {
                ...
                for (int i=0;i<json.length();i++){
                    ...
                    listnewsData.add(new AdapterItems(user.getString("date_demande"),user.getString("heure_demande"),user.getString("date_depart")
                            ,user.getString("heure_depart"),user.getString("Sex_tax_pref")
